        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                ...
                <div class="flex flex-col items-center justify-between item-card gap-y-10 md:flex-row">
                    ...
                    <a href="{{route('admin.courses.create')}}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full w-fit">
                        Create New Course
                    </a>
                </div>
                @endrole
                ...
                <a href="{{route('front.index')}}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full w-fit">
                    Explore Catalog
                </a>
                @endrole
            </div>
